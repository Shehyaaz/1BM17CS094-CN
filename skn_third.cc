/*
3. Create a simple topology of two nodes separated by a point to point link. Demonstrate
the use of FlowMonitor.
*/
...
int main (int argc, char *argv[]){
	...
	for (std::map<FlowId, FlowMonitor::FlowStats>::const_iterator i = stats.begin (); i != stats.end(); ++i){
		...
		std::cout<<" t.sourceAddress="<<t.sourceAddress<<"t.destinationAddress="<<
		t.destinationAddress<<" Source port:"<<t.sourcePort<<" "
